; Compilacion de subrutinas para entrada y salida estandar de 32 bits
; creador: Daniel
; fecha: 10 de marzo del 2023
; Ejemplo no. 4 archivos de cabecera en ensam blador, implementacion de subrutinas
; NOTA: usaremos eax para transferir parametros, si son mas, la pila
...
; -------------------IMPRESION DE ENTEROS CON FIN DE LINEA-------------
;print(f"{int(eax)}\n")
printIntLn:
    call printInt
